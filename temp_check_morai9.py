...
for m in matches:
    ...
    if depth == 0:
        ...
        print('After:', repr(content[close_pos+6:close_pos+150]))
        break

# Check overall div counts
print(f'\nOverall: opens={content.count("<div ")}, closes={content.count("</div>")}, diff={content.count("<div ") - content.count("</div>")}')